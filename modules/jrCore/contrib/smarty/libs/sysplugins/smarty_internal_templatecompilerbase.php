...
abstract class Smarty_Internal_TemplateCompilerBase {
    ...
    public function compileTag($tag, $args, $parameter = array()) {
        ...
        if ($_output !== false) {
            ...
            // Show error if developer mode is on
            if (jrUser_is_admin() && isset($_conf['jrDeveloper_developer_mode']) && $_conf['jrDeveloper_developer_mode'] == 'on') {
                return 'INVALID SMARTY TAG: '. $tag;
            }
            return '';
        }
    }
